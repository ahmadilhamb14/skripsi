...
class AdminController extends Controller
{
    ...
    public function kelola_pemerintah()
    {
        ...
        $kepdes = DB::table('pemerintah__models')->where('type', 'kepala desa')->first();
        $sekdes = DB::table('pemerintah__models')->where('type', 'sekretaris')->first();
